...
public class MSCRMClient {
    ...
    public OrganizationServiceStub doGetOnlineConnection() throws Exception {
	    ...
	    options.setProperty(org.apache.axis2.kernel.http.HTTPConstants.REUSE_HTTP_CLIENT, clientConfiguration.isReuseHttpClient());
	    options.setTimeOutInMilliSeconds(Long.valueOf(clientConfiguration.getTimeout()));
	    options.setProperty(org.apache.axis2.kernel.http.HTTPConstants.SO_TIMEOUT, clientConfiguration.getTimeout());
	    options.setProperty(org.apache.axis2.kernel.http.HTTPConstants.CONNECTION_TIMEOUT, clientConfiguration.getTimeout());
        return serviceStub;
